        ...
        this.mousecaptor.bind('drag interpolate', function(e) {
            ...
            if (targeted.length) {
                ...
                if(cursor_size>0 && e.type=="mousedown") {/**/
                    //Event: I've clicked a node when the cursor_size is ON
 ...
 */
   ...
   */
        function empty() {  
            if(typeof(self.nodes)!=="undefined" &&  self.nodes.length != (numberOfDocs+numberOfNGrams) ) {
                //pr("swclick: "+swclick+" - #partialGraph.nodes: "+self.nodes.length+" - #docs: "+numberOfDocs+" - #ngrams: "+numberOfNGrams);
                ...
                case 'curve':
                    ...
                    if(overNodes==false) {
                        ...
                        if(color == '#9b9e9e') {
                            ...
                            ctx.lineWidth = edge['displaySize']*1.5;/**/
                        }
                    }
                    ctx.beginPath();
                    ctx.moveTo(x1, y1);
