 ...
 */
   ...
   */
        function translate(sceneX, sceneY, ratio, parseNodes, parseEdges) {
            ...
            console.log("ratio: "+ratio+" - Math.sqrt(ratio): "+Math.sqrt(ratio));
            parseEdges && self.edges.forEach(function(edge) {
        ...
        function drawEdge(edge) { 
            ...
            switch (edge['type'] || self.p.defaultEdgeType) {
                case 'curve':
                    ...
                    if(overNodes==false) ctx.lineWidth = edge['displaySize'] / 3;
                    else {
                        if(color == '#9b9e9e') ctx.lineWidth = edge['displaySize'] / 16;
                        else ctx.lineWidth = edge['displaySize']*1.5;/**/
                    }
                    ctx.beginPath();
                    ctx.moveTo(x1, y1);
