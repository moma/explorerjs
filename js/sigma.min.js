...
*/
   ...
   */
        function drawEdge(edge) {
            ...
            var ident = edge.attr.sourceID.charAt(0)+edge.attr.targetID.charAt(0);
            ...
            var color;
            //console.log(edge);
            if(edge.label=="nodes1" || ident=="DD") {
                color = "#cedc75";
            }
            if(edge.label=="nodes2" || ident=="NN") {
                color = "#f4c673";
            }
            if(edge.label=="bipartite" || ident=="DN" || ident=="ND") {
                color = "#7e9bc2";
            }
            
            
//                    initial1 = existingNodes[i].id.charAt(0)+existingNodes[j].id.charAt(0);
//                    initial2 = existingNodes[j].id.charAt(0)+existingNodes[i].id.charAt(0);
//                    var label1="";
//                    if(initial1=="DD"){ label1="nodes1"}
//                    if(initial1=="NN"){label1="nodes2"}
//                    if(initial1=="DN"){label1="bipartite"}
//                    if(initial1=="ND"){label1="bipartite"}
//                    
//                    var label2="";
//                    if(initial2=="DD"){ label2="nodes1"}
//                    if(initial2=="NN"){label2="nodes2"}
//                    if(initial2=="DN"){label2="bipartite"}
//                    if(initial2=="ND"){label2="bipartite"}
