...
return htmlentities($gexf, ENT_COMPAT, 'UTF-8');

//exec("java -jar tinaviz-2.0-SNAPSHOT.jar ".$gexf, $output);
//exec("ping -c 4 google.cl",$output);
//print_r($output);
//echo 'java -jar tinaviz-2.0-SNAPSHOT.jar '.$gexf;
//echo $gexf;
