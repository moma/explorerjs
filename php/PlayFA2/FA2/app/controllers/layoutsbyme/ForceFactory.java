...
public class ForceFactory {
    ...
    public abstract class AttractionForce {
        ...
        public abstract void apply(ANode n1, ANode n2, double e); // Model for node-node attraction (e is for edge weight if needed)
    }

    public abstract class RepulsionForce {

        public abstract void apply(ANode n1, ANode n2);           // Model for node-node repulsion

        public abstract void apply(ANode n, Region r);           // Model for Barnes Hut approximation

        public abstract void apply(ANode n, double g);           // Model for gravitation (anti-repulsion)
    }
    ...
    private class linRepulsion extends RepulsionForce {
        ...
        @Override
        public void apply(ANode n1, ANode n2) {
        ...
        @Override
        public void apply(ANode n, Region r) {
        ...
        @Override
        public void apply(ANode n, double g) {
            ForceAtlas2LayoutData nLayout = n.getLayoutData();
    ...
    private class linAttraction extends AttractionForce {
        ...
        @Override
        public void apply(ANode n1, ANode n2, double e) {
            ForceAtlas2LayoutData n1Layout = n1.getLayoutData();
            ForceAtlas2LayoutData n2Layout = n2.getLayoutData();
