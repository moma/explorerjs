...
public class ForceAtlas2 /*extends GraphLock*/ {
    ...
    public ForceAtlas2(ArrayList<Node_copy> nodes, ArrayList<Edge_copy> edges) {
...
//        Node_copy[] nodes = (Node_copy[]) legraphe.getNds().toArray();//Extraer nodos
...
//
//        ArrayList<Node_copy> nodesArrayList = legraphe.getNds();
//        Node_copy[] nodes = new Node_copy[nodesArrayList.size()];
//        nodesArrayList.toArray(nodes);
//
//        ArrayList<Edge_copy> edgesArrayList = legraphe.getEgs();
//        Edge_copy[] edges = new Edge_copy[edgesArrayList.size()];
...
//                        Node_copy n1 = nodes[i1++];
//                        for (int i2 = 0; i2 < nodes.length; i2++) {
//                            if (i2 < i1){
//                                Node_copy n2 = nodes[i2];
...
//    }
    ...
    public void goAlgo() {
        ...
        //Node_copy[] nodes = (Node_copy[]) legraphe.getNds().toArray();//Extraer nodos
        //Edge_copy[] edges = (Edge_copy[]) legraphe.getEgs().toArray();//Extraer aristas
...
//    }
//    public void endAlgo() {
//        for (Node_copy n : graph.getNodes()) {
